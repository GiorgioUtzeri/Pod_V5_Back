...
class VideoViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(
        summary="Extract video thumbnail",
        description="Generates and saves a video thumbnail at the specified timestamp.",
        request={
            "application/json": {
                "type": "object",
                "properties": {
        ...
        responses={
            200: OpenApiResponse(description="Thumbnail generated successfully."),
            400: OpenApiResponse(description="Invalid timestamp or extraction failed."),
        },
    )
    @action(detail=True, methods=["post"])
    def extract_thumbnail(self, request, slug=None):
        """
