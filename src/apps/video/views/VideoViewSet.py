...
class VideoViewSet(viewsets.ModelViewSet):
    ...
    def _bulk_delete(self, request, video_ids, videos):
        ...
        if len(video_ids) > self.BULK_ASYNC_THRESHOLD:
    ...
    def _bulk_patch(self, request, video_ids, videos):
        ...
        return Response({"updated": videos.count()}, status=status.HTTP_200_OK)
    ...
    @extend_schema(
        ...
        description=(
            ...
            "If more than 20 videos are selected, the operation is processed "
