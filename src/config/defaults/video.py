...
OAI_PMH_REPOSITORY_NAME = ""  # OAI repository name (e.g. "Pod - University of Lille")
OAI_PMH_ADMIN_EMAIL = ""  # OAI repository administrator email
OAI_PMH_BASE_URL = ""  # Base URL of the OAI endpoint (/api/oai-pmh/)
OAI_PMH_PAGE_SIZE = 50  # Number of results per page (ListRecords)
